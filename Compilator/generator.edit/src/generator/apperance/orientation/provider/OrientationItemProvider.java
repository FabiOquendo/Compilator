/**
 */
package generator.apperance.orientation.provider;
...
/**
 * This is the item provider adapter for a {@link generator.apperance.orientation.Orientation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrientationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Orientation_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Orientation_value_feature", "_UI_Orientation_type"),
				 OrientationPackage.Literals.ORIENTATION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Orientation)object).getValue();
		return label == null || label.length() == 0 ?
			getString("_UI_Orientation_type") :
			getString("_UI_Orientation_type") + " " + label;
	}

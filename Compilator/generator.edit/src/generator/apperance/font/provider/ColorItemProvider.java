/**
 */
package generator.apperance.font.provider;
...
/**
 * This is the item provider adapter for a {@link generator.apperance.font.Color} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Color_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Color_value_feature", "_UI_Color_type"),
				 FontPackage.Literals.COLOR__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Color)object).getValue();

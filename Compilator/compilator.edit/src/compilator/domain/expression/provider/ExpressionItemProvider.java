/**
 */
package compilator.domain.expression.provider;
...
/**
 * This is the item provider adapter for a {@link compilator.domain.expression.Expression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionPackage.Literals.EXPRESSION__THE_SENTENCE);
			childrenFeatures.add(ExpressionPackage.Literals.EXPRESSION__THE_EXPRESSION_MODEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionPackage.Literals.EXPRESSION__THE_SENTENCE,
				 SentenceFactory.eINSTANCE.createSentence()));

		newChildDescriptors.add
			(createChildParameter
				(ExpressionPackage.Literals.EXPRESSION__THE_EXPRESSION_MODEL,
				 ExpressionmodelFactory.eINSTANCE.createExpressionModel()));
	}

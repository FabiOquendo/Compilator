...
public class EditStyleDialog extends Dialog {
    ...
    public EditStyleDialog(Shell parentShell, Style theStyle, CharacteristicFactory theCharacteristicFactory) {
        super(parentShell);
        configureShell(parentShell);
        name = theStyle.getName();
        if(theStyle.getTheCharacteristic() != null)
        	characteristic = theStyle.getTheCharacteristic().getName();
        else
        	characteristic = "";
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        grpEditarPropiedad.setText("Editar Estilo");
        ...
        for(int i = 0; i < characteristics.length; i++) {
        	if(characteristic.equals(characteristics[i])) {
        		comboViewer.setSelection(new StructuredSelection(characteristics[i]));
        	}
        }

...
public class EditPropertieDialog extends Dialog {
    ...
    public EditPropertieDialog(Shell parentShell, Propertie propertie) {
        super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        grpEditarPropiedad.setText("Editar Propiedad");
        ...
        for(int i = 0; i < properties.length; i++) {
        	if(name.equals(properties[i])) {
        		comboViewer.setSelection(new StructuredSelection(properties[i]));
        	}
        }

 ...
 * @generated
 */
public class IndividualcomponentSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public IndividualcomponentSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IndividualcomponentPackage.BUTTON: {
			...
			case IndividualcomponentPackage.INDIVIDUAL_ELEMENT: {
				IndividualElement individualElement = (IndividualElement)theEObject;
				T result = caseIndividualElement(individualElement);
				if (result == null) result = caseElement(individualElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IndividualcomponentPackage.LABEL: {
			...
			case IndividualcomponentPackage.COLUMN: {
			...
			case IndividualcomponentPackage.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = caseIndividualElement(table);
				if (result == null) result = caseElement(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IndividualcomponentPackage.ITEM: {
				Item item = (Item)theEObject;
				T result = caseItem(item);
				if (result == null) result = caseIndividualElement(item);
				if (result == null) result = caseElement(item);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IndividualcomponentPackage.ATTRIBUTE: {

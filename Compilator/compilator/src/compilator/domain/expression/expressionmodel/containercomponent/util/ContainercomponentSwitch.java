 ...
 * @generated
 */
public class ContainercomponentSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ContainercomponentSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContainercomponentPackage.CONTAINER_ELEMENT: {
			...
			case ContainercomponentPackage.CONTAINER: {
				Container container = (Container)theEObject;
				T result = caseContainer(container);
				if (result == null) result = caseContainerElement(container);

...
public class ExpressionSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ExpressionPackage.ELEMENT:
      {
      ...
      case ExpressionPackage.TEXT_VIEW:
      {
        ...
        if (result == null) result = caseElement(textView);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ExpressionPackage.COMBO_VIEW:
      {
        ComboView comboView = (ComboView)theEObject;
        T result = caseComboView(comboView);
        if (result == null) result = caseElement(comboView);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Combo View</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Combo View</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseComboView(ComboView object)
  {
    return null;
  }

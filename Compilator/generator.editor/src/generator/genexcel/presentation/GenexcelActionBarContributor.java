...
/**
 * This is the action bar contributor for the Genexcel model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenexcelActionBarContributor
	 ...
	 * @generated
	 */
	public GenexcelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("genexcel-settings"));
		toolBarManager.add(new Separator("genexcel-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GenexcelEditor_menu"), "generator.genexcelMenuID");

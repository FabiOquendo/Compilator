...
/**
 * This is the action bar contributor for the Gendataform model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GendataformActionBarContributor
	 ...
	 * @generated
	 */
	public GendataformActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("gendataform-settings"));
		toolBarManager.add(new Separator("gendataform-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GendataformEditor_menu"), "generator.gendataformMenuID");

...
/**
 * This is the action bar contributor for the Position model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PositionActionBarContributor
	 ...
	 * @generated
	 */
	public PositionActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("position-settings"));
		toolBarManager.add(new Separator("position-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_PositionEditor_menu"), "generator.apperance.positionMenuID");

...
/**
 * This is the action bar contributor for the Size model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SizeActionBarContributor
	 ...
	 * @generated
	 */
	public SizeActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("size-settings"));
		toolBarManager.add(new Separator("size-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_SizeEditor_menu"), "generator.apperance.sizeMenuID");

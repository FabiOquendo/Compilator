...
/**
 * This is the action bar contributor for the Orientation model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrientationActionBarContributor
	 ...
	 * @generated
	 */
	public OrientationActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("orientation-settings"));
		toolBarManager.add(new Separator("orientation-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_OrientationEditor_menu"), "generator.apperance.orientationMenuID");

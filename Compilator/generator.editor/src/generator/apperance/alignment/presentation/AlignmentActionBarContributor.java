...
/**
 * This is the action bar contributor for the Alignment model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlignmentActionBarContributor
	 ...
	 * @generated
	 */
	public AlignmentActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("alignment-settings"));
		toolBarManager.add(new Separator("alignment-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_AlignmentEditor_menu"), "generator.apperance.alignmentMenuID");

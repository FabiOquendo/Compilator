...
/**
 * This is the action bar contributor for the Font model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FontActionBarContributor
	 ...
	 * @generated
	 */
	public FontActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("font-settings"));
		toolBarManager.add(new Separator("font-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_FontEditor_menu"), "generator.apperance.fontMenuID");

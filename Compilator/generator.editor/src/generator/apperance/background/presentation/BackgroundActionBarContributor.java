...
/**
 * This is the action bar contributor for the Background model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BackgroundActionBarContributor
	 ...
	 * @generated
	 */
	public BackgroundActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("background-settings"));
		toolBarManager.add(new Separator("background-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_BackgroundEditor_menu"), "generator.apperance.backgroundMenuID");

...
/**
 * This is the action bar contributor for the Titlesize model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TitlesizeActionBarContributor
	 ...
	 * @generated
	 */
	public TitlesizeActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("titlesize-settings"));
		toolBarManager.add(new Separator("titlesize-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_TitlesizeEditor_menu"), "generator.apperance.titlesizeMenuID");

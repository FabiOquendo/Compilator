...
/**
 * This is the action bar contributor for the Linesvisible model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinesvisibleActionBarContributor
	 ...
	 * @generated
	 */
	public LinesvisibleActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("linesvisible-settings"));
		toolBarManager.add(new Separator("linesvisible-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_LinesvisibleEditor_menu"), "generator.apperance.linesvisibleMenuID");

...
/**
 * This is the action bar contributor for the Gencontainer model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GencontainerActionBarContributor
	 ...
	 * @generated
	 */
	public GencontainerActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("gencontainer-settings"));
		toolBarManager.add(new Separator("gencontainer-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GencontainerEditor_menu"), "generator.genmodel.gencontainercomponent.gencontainerMenuID");

...
/**
 * This is the action bar contributor for the Genlabel model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenlabelActionBarContributor
	 ...
	 * @generated
	 */
	public GenlabelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("genlabel-settings"));
		toolBarManager.add(new Separator("genlabel-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GenlabelEditor_menu"), "generator.genmodel.genindividualcomponent.genlabelMenuID");

...
/**
 * This is the action bar contributor for the Gentable model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GentableActionBarContributor
	 ...
	 * @generated
	 */
	public GentableActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("gentable-settings"));
		toolBarManager.add(new Separator("gentable-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GentableEditor_menu"), "generator.genmodel.genindividualcomponent.gentableMenuID");

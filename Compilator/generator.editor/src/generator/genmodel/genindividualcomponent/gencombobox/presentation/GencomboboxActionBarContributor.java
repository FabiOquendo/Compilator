...
/**
 * This is the action bar contributor for the Gencombobox model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GencomboboxActionBarContributor
	 ...
	 * @generated
	 */
	public GencomboboxActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("gencombobox-settings"));
		toolBarManager.add(new Separator("gencombobox-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GencomboboxEditor_menu"), "generator.genmodel.genindividualcomponent.gencomboboxMenuID");

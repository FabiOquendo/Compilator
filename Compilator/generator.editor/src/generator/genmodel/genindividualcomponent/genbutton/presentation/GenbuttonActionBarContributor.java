...
/**
 * This is the action bar contributor for the Genbutton model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenbuttonActionBarContributor
	 ...
	 * @generated
	 */
	public GenbuttonActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("genbutton-settings"));
		toolBarManager.add(new Separator("genbutton-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GenbuttonEditor_menu"), "generator.genmodel.genindividualcomponent.genbuttonMenuID");

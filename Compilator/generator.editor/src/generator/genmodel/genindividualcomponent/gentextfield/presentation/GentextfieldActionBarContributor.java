...
/**
 * This is the action bar contributor for the Gentextfield model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GentextfieldActionBarContributor
	 ...
	 * @generated
	 */
	public GentextfieldActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("gentextfield-settings"));
		toolBarManager.add(new Separator("gentextfield-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GentextfieldEditor_menu"), "generator.genmodel.genindividualcomponent.gentextfieldMenuID");

...
/**
 * This is the action bar contributor for the Gencolunm model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GencolunmActionBarContributor
	 ...
	 * @generated
	 */
	public GencolunmActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("gencolunm-settings"));
		toolBarManager.add(new Separator("gencolunm-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GeneratorEditorPlugin.INSTANCE.getString("_UI_GencolunmEditor_menu"), "generator.genmodel.genindividualcomponent.gencolunmMenuID");

 ...
 * Form Diagram Generator</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link generator.gendataform.impl.DataFormDiagramGeneratorImpl#getModelFactory
 * <em>Model Factory</em>}</li>
 * <li>{@link generator.gendataform.impl.DataFormDiagramGeneratorImpl#getDataformDiagram
 * <em>Dataform Diagram</em>}</li>
 * <li>{@link generator.gendataform.impl.DataFormDiagramGeneratorImpl#getInterface1
 * <em>Interface1</em>}</li>
 * </ul>
 *
 * @generated
...
public class DataFormDiagramGeneratorImpl extends MinimalEObjectImpl.Container implements DataFormDiagramGenerator {
	/**
	 * The default value of the '{@link #getModelFactory() <em>Model Factory</em>}'
	...
	/**
	 * The cached value of the '{@link #getModelFactory() <em>Model Factory</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getModelFactory()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getDataformDiagram() <em>Dataform
	 * Diagram</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getDataformDiagram() <em>Dataform
	 * Diagram</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDataformDiagram()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getInterface1() <em>Interface1</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getInterface1()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getInterface1() <em>Interface1</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getInterface1()
	 * @generated
	...
	public void setModelFactory(ModelFactory newModelFactory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GendataformPackage.DATA_FORM_DIAGRAM_GENERATOR__MODEL_FACTORY, oldModelFactory, modelFactory));
	}
	...
	public void setDataformDiagram(DataForm_Diagram newDataformDiagram) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GendataformPackage.DATA_FORM_DIAGRAM_GENERATOR__DATAFORM_DIAGRAM, oldDataformDiagram,
					dataformDiagram));
	}
	...
	public void setInterface1(Interface newInterface1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GendataformPackage.DATA_FORM_DIAGRAM_GENERATOR__INTERFACE1, oldInterface1, interface1));
	}
...
this.interface1 = dataformDiagram.getTheInterface();
	...
	public void salvarDiagram(final Diagram diagram) {
		...
		org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI
				.createURI("platform:/resource/test/domain/model.tooldataform_diagram");
	...
	public Diagram createDiagram() {
		...
		Diagram diagram = org.eclipse.gmf.runtime.diagram.core.services.ViewService.createDiagram(dataformDiagram,
				tooldataform.diagram.edit.parts.DataForm_DiagramEditPart.MODEL_ID,
				tooldataform.diagram.part.MetamodelodataformDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
		// save the ressource
		try {
			dataformDiagram.eResource()
					.save(tooldataform.diagram.part.MetamodelodataformDiagramEditorUtil.getSaveOptions());
		} catch (java.io.IOException e) {
			tooldataform.diagram.part.MetamodelodataformDiagramEditorPlugin.getInstance()
					.logError("Save operation failed for: " + dataformDiagram.eResource(), e); //$NON-NLS-1$
		}

		Node node = org.eclipse.gmf.runtime.diagram.core.services.ViewService.getInstance().createNode(
				new org.eclipse.gmf.runtime.emf.core.util.EObjectAdapter(interface1), diagram, null, 0, true,
				tooldataform.diagram.part.MetamodelodataformDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
		Bounds bounds = createBounds(interface1.getPositionX(), interface1.getPositionY(), interface1.getWidth(),
				interface1.getHeight());
	...
	public String getFontDataformElement(ModelElementDataForm element) {
...
if (element instanceof GraphicalContainer) {
	...
	EList<Propertie> listProperties = graphicalContainer.getTheStyle().getTheCharacteristic()
			.getListProperties();
	...
	GraphicalIndividualEement individualElement = (GraphicalIndividualEement) element;
	EList<Propertie> listProperties = individualElement.getTheStyle().getTheCharacteristic()
			.getListProperties();
	for (int i = 0; i < listProperties.size(); i++) {
		if (listProperties.get(i).getName().equals("Font Type"))
			font = listProperties.get(i).getValue();
...
return font;
	...
	public int getFontSizeDataformElement(ModelElementDataForm element) {
...
if (graphicalContainer instanceof tooldataform.formmodel.concreta.TableView) {
	...
	public void openDiagram(final Diagram diag) {
		...
		try {
			...
			org.eclipse.ui.IWorkbenchPage page = org.eclipse.ui.PlatformUI.getWorkbench().getActiveWorkbenchWindow()
					.getActivePage();
			page.openEditor(new org.eclipse.emf.common.ui.URIEditorInput(uri, dataformDiagram.getName()),
					tooldataform.diagram.part.MetamodelodataformDiagramEditor.ID);
	...
	public boolean eIsSet(int featureID) {
		...
		case GendataformPackage.DATA_FORM_DIAGRAM_GENERATOR__DATAFORM_DIAGRAM:
			return DATAFORM_DIAGRAM_EDEFAULT == null ? dataformDiagram != null
					: !DATAFORM_DIAGRAM_EDEFAULT.equals(dataformDiagram);
		case GendataformPackage.DATA_FORM_DIAGRAM_GENERATOR__INTERFACE1:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case GendataformPackage.DATA_FORM_DIAGRAM_GENERATOR___CREATE_BOUNDS__INT_INT_INT_INT:
			return createBounds((Integer) arguments.get(0), (Integer) arguments.get(1), (Integer) arguments.get(2),

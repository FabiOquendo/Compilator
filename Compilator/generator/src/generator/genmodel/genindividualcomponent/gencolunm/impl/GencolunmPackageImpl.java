 ...
 * @generated
 */
public class GencolunmPackageImpl extends EPackageImpl implements GencolunmPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass genColumnEClass = null;
	 ...
	 * @see generator.genmodel.genindividualcomponent.gencolunm.GencolunmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GencolunmPackageImpl() {
		super(eNS_URI, GencolunmFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GencolunmPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GencolunmPackage init() {
		if (isInited) return (GencolunmPackage)EPackage.Registry.INSTANCE.getEPackage(GencolunmPackage.eNS_URI);

		// Obtain or create and register package
		GencolunmPackageImpl theGencolunmPackage = (GencolunmPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GencolunmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GencolunmPackageImpl());
		...
		theGencolunmPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GencolunmPackage.eNS_URI, theGencolunmPackage);
		return theGencolunmPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getGenColumn() {
		return genColumnEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getGenColumn_GenTable() {
		return (EReference)genColumnEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGenColumn_TheColumn() {
		return (EReference)genColumnEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getGenColumn_TheAlignment() {
		return (EReference)genColumnEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenColumn__CreatePropertiesColumn__String_Propertie() {
		return genColumnEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenColumn__CreateAlignment() {
		return genColumnEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenColumn__SetDefaultColumn__String_Propertie() {
		return genColumnEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public GencolunmFactory getGencolunmFactory() {
		return (GencolunmFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		genColumnEClass = createEClass(GEN_COLUMN);
		createEReference(genColumnEClass, GEN_COLUMN__GEN_TABLE);
		createEReference(genColumnEClass, GEN_COLUMN__THE_COLUMN);
		createEReference(genColumnEClass, GEN_COLUMN__THE_ALIGNMENT);
		createEOperation(genColumnEClass, GEN_COLUMN___CREATE_PROPERTIES_COLUMN__STRING_PROPERTIE);
		createEOperation(genColumnEClass, GEN_COLUMN___CREATE_ALIGNMENT);
		createEOperation(genColumnEClass, GEN_COLUMN___SET_DEFAULT_COLUMN__STRING_PROPERTIE);
	}
	...
	public void initializePackageContents() {
		...
		genColumnEClass.getESuperTypes().add(theGenindividualcomponentPackage.getGenIndividualElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(genColumnEClass, GenColumn.class, "GenColumn", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGenColumn_GenTable(), theGentablePackage.getGenTable(), theGentablePackage.getGenTable_ListGenColumns(), "GenTable", null, 0, 1, GenColumn.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGenColumn_TheColumn(), theIndividualcomponentPackage.getColumn(), null, "theColumn", null, 1, 1, GenColumn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGenColumn_TheAlignment(), theAlignmentPackage.getAlignment(), theAlignmentPackage.getAlignment_GenColumn(), "theAlignment", null, 1, 1, GenColumn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getGenColumn__CreatePropertiesColumn__String_Propertie(), null, "createPropertiesColumn", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getGenColumn__CreateAlignment(), null, "createAlignment", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getGenColumn__SetDefaultColumn__String_Propertie(), null, "setDefaultColumn", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "text", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDatatypesPackage.getPropertie(), "fontSize", 0, 1, IS_UNIQUE, IS_ORDERED);
	}

} //GencolunmPackageImpl

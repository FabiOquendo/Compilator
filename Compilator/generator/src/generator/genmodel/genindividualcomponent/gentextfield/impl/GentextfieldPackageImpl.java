 ...
 * @generated
 */
public class GentextfieldPackageImpl extends EPackageImpl implements GentextfieldPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass genTextFieldEClass = null;
	 ...
	 * @see generator.genmodel.genindividualcomponent.gentextfield.GentextfieldPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GentextfieldPackageImpl() {
		super(eNS_URI, GentextfieldFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GentextfieldPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GentextfieldPackage init() {
		if (isInited) return (GentextfieldPackage)EPackage.Registry.INSTANCE.getEPackage(GentextfieldPackage.eNS_URI);

		// Obtain or create and register package
		GentextfieldPackageImpl theGentextfieldPackage = (GentextfieldPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GentextfieldPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GentextfieldPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(GentextfieldPackage.eNS_URI, theGentextfieldPackage);
		return theGentextfieldPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getGenTextField() {
		return genTextFieldEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getGenTextField_TheBackground() {
		return (EReference)genTextFieldEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGenTextField_TheTextField() {
		return (EReference)genTextFieldEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenTextField__CreatePropertiesTextField__Propertie() {
		return genTextFieldEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenTextField__CreateBackground() {
		return genTextFieldEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenTextField__SetDefaultText__Propertie() {
		return genTextFieldEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public GentextfieldFactory getGentextfieldFactory() {
		return (GentextfieldFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		genTextFieldEClass = createEClass(GEN_TEXT_FIELD);
		createEReference(genTextFieldEClass, GEN_TEXT_FIELD__THE_BACKGROUND);
		createEReference(genTextFieldEClass, GEN_TEXT_FIELD__THE_TEXT_FIELD);
		createEOperation(genTextFieldEClass, GEN_TEXT_FIELD___CREATE_PROPERTIES_TEXT_FIELD__PROPERTIE);
		createEOperation(genTextFieldEClass, GEN_TEXT_FIELD___CREATE_BACKGROUND);
		createEOperation(genTextFieldEClass, GEN_TEXT_FIELD___SET_DEFAULT_TEXT__PROPERTIE);
	}
	...
	public void initializePackageContents() {
		...
		genTextFieldEClass.getESuperTypes().add(theGenindividualcomponentPackage.getGenIndividualElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(genTextFieldEClass, GenTextField.class, "GenTextField", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGenTextField_TheBackground(), theBackgroundPackage.getBackground(), theBackgroundPackage.getBackground_GenTextField(), "theBackground", null, 1, 1, GenTextField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGenTextField_TheTextField(), theIndividualcomponentPackage.getTextField(), null, "theTextField", null, 1, 1, GenTextField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getGenTextField__CreatePropertiesTextField__Propertie(), null, "createPropertiesTextField", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDatatypesPackage.getPropertie(), "fontSize", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getGenTextField__CreateBackground(), null, "createBackground", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getGenTextField__SetDefaultText__Propertie(), null, "setDefaultText", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDatatypesPackage.getPropertie(), "fontSize", 0, 1, IS_UNIQUE, IS_ORDERED);
	}

} //GentextfieldPackageImpl

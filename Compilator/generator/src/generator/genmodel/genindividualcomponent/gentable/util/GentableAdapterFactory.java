 ...
 * @generated
 */
public class GentableAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected GentableSwitch<Adapter> modelSwitch =
		new GentableSwitch<Adapter>() {
			@Override
			public Adapter caseGenTable(GenTable object) {
				return createGenTableAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link generator.genmodel.genindividualcomponent.gentable.GenTable <em>Gen Table</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGenTableAdapter() {
		return null;
	}

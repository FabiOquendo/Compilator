 ...
 * @generated
 */
public class GenlabelPackageImpl extends EPackageImpl implements GenlabelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see generator.genmodel.genindividualcomponent.genlabel.GenlabelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GenlabelPackageImpl() {
		super(eNS_URI, GenlabelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GenlabelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GenlabelPackage init() {
		if (isInited) return (GenlabelPackage)EPackage.Registry.INSTANCE.getEPackage(GenlabelPackage.eNS_URI);

		// Obtain or create and register package
		GenlabelPackageImpl theGenlabelPackage = (GenlabelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GenlabelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GenlabelPackageImpl());
		...
		theGenlabelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GenlabelPackage.eNS_URI, theGenlabelPackage);
		return theGenlabelPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getGenLabel_TheBackground() {
		return (EReference)genLabelEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGenLabel_TheLabel() {
	 ...
	 * @generated
	 */
	public EReference getGenLabel_TheAlignment() {
	 ...
	 * @generated
	 */
	public EOperation getGenLabel__CreatePropertiesLabel__String_Propertie() {
		return genLabelEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenLabel__CreateAlignment() {
		return genLabelEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenLabel__CreateBackground() {
		return genLabelEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenLabel__SetDefaultLabel__String_Propertie() {
		return genLabelEClass.getEOperations().get(3);
	}
	 ...
	 * @generated
	 */
	public GenlabelFactory getGenlabelFactory() {
		return (GenlabelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(genLabelEClass, GEN_LABEL__THE_BACKGROUND);
		createEReference(genLabelEClass, GEN_LABEL__THE_LABEL);
		createEReference(genLabelEClass, GEN_LABEL__THE_ALIGNMENT);
		createEOperation(genLabelEClass, GEN_LABEL___CREATE_PROPERTIES_LABEL__STRING_PROPERTIE);
		createEOperation(genLabelEClass, GEN_LABEL___CREATE_ALIGNMENT);
		createEOperation(genLabelEClass, GEN_LABEL___CREATE_BACKGROUND);
		createEOperation(genLabelEClass, GEN_LABEL___SET_DEFAULT_LABEL__STRING_PROPERTIE);
	}
	...
	public void initializePackageContents() {
		...
		genLabelEClass.getESuperTypes().add(theGenindividualcomponentPackage.getGenIndividualElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(genLabelEClass, GenLabel.class, "GenLabel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGenLabel_TheBackground(), theBackgroundPackage.getBackground(), theBackgroundPackage.getBackground_GenLabel(), "theBackground", null, 1, 1, GenLabel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGenLabel_TheLabel(), theIndividualcomponentPackage.getLabel(), null, "theLabel", null, 1, 1, GenLabel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGenLabel_TheAlignment(), theAlignmentPackage.getAlignment(), theAlignmentPackage.getAlignment_GenLabel(), "theAlignment", null, 1, 1, GenLabel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getGenLabel__CreatePropertiesLabel__String_Propertie(), null, "createPropertiesLabel", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getGenLabel__CreateAlignment(), null, "createAlignment", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getGenLabel__CreateBackground(), null, "createBackground", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getGenLabel__SetDefaultLabel__String_Propertie(), null, "setDefaultLabel", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "text", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDatatypesPackage.getPropertie(), "fontSize", 0, 1, IS_UNIQUE, IS_ORDERED);
	}

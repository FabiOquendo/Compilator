...
import generator.genmodel.genindividualcomponent.GenindividualcomponentFactory;
 ...
 * @generated
 */
public class GenindividualcomponentPackageImpl extends EPackageImpl implements GenindividualcomponentPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass genIndividualElementEClass = null;
	 ...
	 * @see generator.genmodel.genindividualcomponent.GenindividualcomponentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GenindividualcomponentPackageImpl() {
		super(eNS_URI, GenindividualcomponentFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GenindividualcomponentPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GenindividualcomponentPackage init() {
		if (isInited) return (GenindividualcomponentPackage)EPackage.Registry.INSTANCE.getEPackage(GenindividualcomponentPackage.eNS_URI);

		// Obtain or create and register package
		GenindividualcomponentPackageImpl theGenindividualcomponentPackage = (GenindividualcomponentPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GenindividualcomponentPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GenindividualcomponentPackageImpl());
		...
		theGenindividualcomponentPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GenindividualcomponentPackage.eNS_URI, theGenindividualcomponentPackage);
		return theGenindividualcomponentPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getGenIndividualElement() {
		return genIndividualElementEClass;
	}
	 ...
	 * @generated
	 */
	public GenindividualcomponentFactory getGenindividualcomponentFactory() {
		return (GenindividualcomponentFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		genIndividualElementEClass = createEClass(GEN_INDIVIDUAL_ELEMENT);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theGenbuttonPackage);
		getESubpackages().add(theGencolunmPackage);
		getESubpackages().add(theGencomboboxPackage);
		getESubpackages().add(theGenlabelPackage);
		getESubpackages().add(theGentablePackage);
		getESubpackages().add(theGentextfieldPackage);
		...
		genIndividualElementEClass.getESuperTypes().add(theGenmodelPackage.getGenElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(genIndividualElementEClass, GenIndividualElement.class, "GenIndividualElement", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //GenindividualcomponentPackageImpl

/**
 */
package generator.enumeration.impl;
...
import generator.enumeration.EnumerationFactory;
import generator.enumeration.EnumerationPackage;
import generator.enumeration.Height;
import generator.enumeration.Weight;
...
public class EnumerationPackageImpl extends EPackageImpl implements EnumerationPackage {
	 ...
	 * @generated
	 */
	private EEnum heightEEnum = null;
	 ...
	 * @see generator.enumeration.EnumerationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents() {
		...
		heightEEnum = createEEnum(HEIGHT);
	}
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(weightEEnum, Weight.WEIGHT_BUTTON);
		addEEnumLiteral(weightEEnum, Weight.WEIGHT_COLUMN);
		addEEnumLiteral(weightEEnum, Weight.WEIGHT_COMBO);
		addEEnumLiteral(weightEEnum, Weight.WEIGHT_LABEL);
		addEEnumLiteral(weightEEnum, Weight.WEIGHT_TEXTFIELD);

		initEEnum(heightEEnum, Height.class, "Height");
		addEEnumLiteral(heightEEnum, Height.HEIGHT_BUTTON);
		addEEnumLiteral(heightEEnum, Height.HEIGHT_COMBO);
		addEEnumLiteral(heightEEnum, Height.HEIGHT_LABEL);
		addEEnumLiteral(heightEEnum, Height.HEIGHT_TABLE);
		addEEnumLiteral(heightEEnum, Height.HEIGHT_TEXTFIELD);
	}

 ...
 * @generated
 */
public class OrientationPackageImpl extends EPackageImpl implements OrientationPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see generator.apperance.orientation.OrientationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OrientationPackageImpl() {
		super(eNS_URI, OrientationFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link OrientationPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OrientationPackage init() {
		if (isInited) return (OrientationPackage)EPackage.Registry.INSTANCE.getEPackage(OrientationPackage.eNS_URI);

		// Obtain or create and register package
		OrientationPackageImpl theOrientationPackage = (OrientationPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OrientationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OrientationPackageImpl());
		...
		theOrientationPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OrientationPackage.eNS_URI, theOrientationPackage);
		return theOrientationPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getOrientation_GenContainer() {
		return (EReference)orientationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public OrientationFactory getOrientationFactory() {
		return (OrientationFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(orientationEClass, ORIENTATION__GEN_CONTAINER);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getOrientation_GenContainer(), theGencontainerPackage.getGenContainer(), theGencontainerPackage.getGenContainer_TheOrientation(), "GenContainer", null, 0, 1, Orientation.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //OrientationPackageImpl

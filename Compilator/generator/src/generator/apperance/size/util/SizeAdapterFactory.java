/**
 */
package generator.apperance.size.util;
...
public class SizeAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SizeSwitch<Adapter> modelSwitch =
		new SizeSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link generator.apperance.size.Width <em>Width</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link generator.apperance.size.Height <em>Height</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

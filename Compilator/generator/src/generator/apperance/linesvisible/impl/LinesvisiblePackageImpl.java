 ...
 * @generated
 */
public class LinesvisiblePackageImpl extends EPackageImpl implements LinesvisiblePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass linesVisibleEClass = null;
	 ...
	 * @see generator.apperance.linesvisible.LinesvisiblePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LinesvisiblePackageImpl() {
		super(eNS_URI, LinesvisibleFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link LinesvisiblePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static LinesvisiblePackage init() {
		if (isInited) return (LinesvisiblePackage)EPackage.Registry.INSTANCE.getEPackage(LinesvisiblePackage.eNS_URI);

		// Obtain or create and register package
		LinesvisiblePackageImpl theLinesvisiblePackage = (LinesvisiblePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LinesvisiblePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LinesvisiblePackageImpl());
		...
		theLinesvisiblePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(LinesvisiblePackage.eNS_URI, theLinesvisiblePackage);
		return theLinesvisiblePackage;
	}
	 ...
	 * @generated
	 */
	public EClass getLinesVisible() {
		return linesVisibleEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getLinesVisible_Value() {
		return (EAttribute)linesVisibleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getLinesVisible_GenTable() {
		return (EReference)linesVisibleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public LinesvisibleFactory getLinesvisibleFactory() {
		return (LinesvisibleFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		linesVisibleEClass = createEClass(LINES_VISIBLE);
		createEAttribute(linesVisibleEClass, LINES_VISIBLE__VALUE);
		createEReference(linesVisibleEClass, LINES_VISIBLE__GEN_TABLE);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(linesVisibleEClass, LinesVisible.class, "LinesVisible", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLinesVisible_Value(), ecorePackage.getEBooleanObject(), "value", null, 0, 1, LinesVisible.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLinesVisible_GenTable(), theGentablePackage.getGenTable(), theGentablePackage.getGenTable_TheLinesVisible(), "GenTable", null, 0, 1, LinesVisible.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //LinesvisiblePackageImpl

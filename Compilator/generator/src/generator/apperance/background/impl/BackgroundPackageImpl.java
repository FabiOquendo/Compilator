 ...
 * @generated
 */
public class BackgroundPackageImpl extends EPackageImpl implements BackgroundPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see generator.apperance.background.BackgroundPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BackgroundPackageImpl() {
		super(eNS_URI, BackgroundFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BackgroundPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BackgroundPackage init() {
		if (isInited) return (BackgroundPackage)EPackage.Registry.INSTANCE.getEPackage(BackgroundPackage.eNS_URI);

		// Obtain or create and register package
		BackgroundPackageImpl theBackgroundPackage = (BackgroundPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BackgroundPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BackgroundPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(BackgroundPackage.eNS_URI, theBackgroundPackage);
	 ...
	 * @generated
	 */
	public EAttribute getBackground_Value() {
	 ...
	 * @generated
	 */
	public EReference getBackground_GenComboBox() {
	 ...
	 * @generated
	 */
	public EReference getBackground_GenTextField() {
	 ...
	 * @generated
	 */
	public EReference getBackground_GenLabel() {
	 ...
	 * @generated
	 */
	public EReference getBackground_GenTable() {
	 ...
	 * @generated
	 */
	public EReference getBackground_GenContainer() {
		return (EReference)backgroundEClass.getEStructuralFeatures().get(5);
	}
	...
	public BackgroundFactory getBackgroundFactory() {
		return (BackgroundFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(backgroundEClass, BACKGROUND__VALUE);
		createEReference(backgroundEClass, BACKGROUND__GEN_COMBO_BOX);
		createEReference(backgroundEClass, BACKGROUND__GEN_TEXT_FIELD);
		createEReference(backgroundEClass, BACKGROUND__GEN_LABEL);
		createEReference(backgroundEClass, BACKGROUND__GEN_TABLE);
		createEReference(backgroundEClass, BACKGROUND__GEN_CONTAINER);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBackground_Value(), ecorePackage.getEString(), "value", null, 0, 1, Background.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBackground_GenComboBox(), theGencomboboxPackage.getGenComboBox(), theGencomboboxPackage.getGenComboBox_TheBackground(), "GenComboBox", null, 0, 1, Background.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBackground_GenTextField(), theGentextfieldPackage.getGenTextField(), theGentextfieldPackage.getGenTextField_TheBackground(), "GenTextField", null, 0, 1, Background.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBackground_GenLabel(), theGenlabelPackage.getGenLabel(), theGenlabelPackage.getGenLabel_TheBackground(), "GenLabel", null, 0, 1, Background.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBackground_GenTable(), theGentablePackage.getGenTable(), theGentablePackage.getGenTable_TheBackground(), "GenTable", null, 0, 1, Background.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBackground_GenContainer(), theGencontainerPackage.getGenContainer(), theGencontainerPackage.getGenContainer_TheBackground(), "GenContainer", null, 0, 1, Background.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //BackgroundPackageImpl

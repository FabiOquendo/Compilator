...
public interface Generator extends EObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='GenColumn genColumn = generator.genmodel.genindividualcomponent.gencolunm.GencolunmFactory.eINSTANCE.createGenColumn();\r\ngenColumn.setTheColumn(column);\r\nString text = column.getName();\r\nstyles.domain.Propertie fontSize = null;\r\nEList&lt;styles.domain.Propertie&gt; listProperties = column.getTheSytle().getTheCharacteristic().getListProperties();\r\nfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\tif(listProperties.get(i).getName().equals(\"Font Size\")) {\r\n\t\tfontSize = listProperties.get(i);\r\n\t\tbreak;\r\n\t}\r\n}\t\t\t\r\ngenColumn.createPropertiesColumn(text, fontSize);\r\n\r\nif(column.getTheSytle() != null) {\r\n\tgenColumn = (GenColumn) setApperances(column, genColumn);\r\n\tfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\t\tstyles.domain.Propertie propertie = listProperties.get(i);\r\n\t\t\r\n\t\tif(propertie.getName().equals(\"Alignment\")) {\r\n\t\t\tgenerator.apperance.alignment.Alignment a = generator.apperance.alignment.AlignmentFactory.eINSTANCE.createAlignment();\r\n\t\t\ta.setValue(propertie.getValue());\r\n\t\t\tgenColumn.setTheAlignment(a);\r\n\t\t}\r\n\t}\r\n}\r\nreturn genColumn;'"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='GenComboBox genCombo = generator.genmodel.genindividualcomponent.gencombobox.GencomboboxFactory.eINSTANCE.createGenComboBox();\r\ngenCombo.setTheComboBox(combo);\r\nstyles.domain.Propertie fontSize = null;\r\nEList&lt;styles.domain.Propertie&gt; listProperties = combo.getTheSytle().getTheCharacteristic().getListProperties();\r\nfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\tif(listProperties.get(i).getName().equals(\"Font Size\")) {\r\n\t\tfontSize = listProperties.get(i);\r\n\t\tbreak;\r\n\t}\r\n}\r\ngenCombo.createPropertiesComboBox(fontSize);\r\n\r\nif(combo.getTheSytle() != null) {\r\n\tgenCombo = (GenComboBox) setApperances(combo, genCombo);\r\n\tfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\t\tstyles.domain.Propertie propertie = listProperties.get(i);\r\n\t\t\r\n\t\tif(propertie.getName().equals(\"Background\")) {\r\n\t\t\tgenerator.apperance.background.Background b = generator.apperance.background.BackgroundFactory.eINSTANCE.createBackground();\r\n\t\t\tb.setValue(propertie.getValue());\r\n\t\t\tgenCombo.setTheBackground(b);\r\n\t\t}\r\n\t}\r\n}\r\nreturn genCombo;'"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='GenLabel genLabel = generator.genmodel.genindividualcomponent.genlabel.GenlabelFactory.eINSTANCE.createGenLabel();\r\ngenLabel.setTheLabel(label);\r\nString text = label.getName();\r\nstyles.domain.Propertie fontSize = null;\r\nEList&lt;styles.domain.Propertie&gt; listProperties = label.getTheSytle().getTheCharacteristic().getListProperties();\r\nfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\tif(listProperties.get(i).getName().equals(\"Font Size\")) {\r\n\t\tfontSize = listProperties.get(i);\r\n\t\tbreak;\r\n\t}\r\n}\r\ngenLabel.createPropertiesLabel(text, fontSize);\r\n\r\nif(label.getTheSytle() != null) {\r\n\tgenLabel = (GenLabel) setApperances(label, genLabel);\r\n\tfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\t\tstyles.domain.Propertie propertie = listProperties.get(i);\r\n\t\t\r\n\t\tif(propertie.getName().equals(\"Alignment\")) {\r\n\t\t\tgenerator.apperance.alignment.Alignment a = generator.apperance.alignment.AlignmentFactory.eINSTANCE.createAlignment();\r\n\t\t\ta.setValue(propertie.getValue());\r\n\t\t\tgenLabel.setTheAlignment(a);\r\n\t\t} else if(propertie.getName().equals(\"Background\")) {\r\n\t\t\tgenerator.apperance.background.Background b = generator.apperance.background.BackgroundFactory.eINSTANCE.createBackground();\r\n\t\t\tb.setValue(propertie.getValue());\r\n\t\t\tgenLabel.setTheBackground(b);\r\n\t\t}\r\n\t}\r\n}\r\nreturn genLabel;'"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='GenTextField genText = generator.genmodel.genindividualcomponent.gentextfield.GentextfieldFactory.eINSTANCE.createGenTextField();\t\t\r\ngenText.setTheTextField(text);\r\nstyles.domain.Propertie fontSize = null;\r\nEList&lt;styles.domain.Propertie&gt; listProperties = text.getTheSytle().getTheCharacteristic().getListProperties();\r\nfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\tif(listProperties.get(i).getName().equals(\"Font Size\")) {\r\n\t\tfontSize = listProperties.get(i);\r\n\t\tbreak;\r\n\t}\r\n}\r\ngenText.createPropertiesTextField(fontSize);\r\n\r\nif(text.getTheSytle() != null) {\r\n\tgenText = (GenTextField) setApperances(text, genText);\r\n\tfor (int i = 0; i &lt; listProperties.size(); i++) {\r\n\t\tstyles.domain.Propertie propertie = listProperties.get(i);\r\n\t\t\r\n\t\tif(propertie.getName().equals(\"Background\")) {\r\n\t\t\tgenerator.apperance.background.Background b = generator.apperance.background.BackgroundFactory.eINSTANCE.createBackground();\r\n\t\t\tb.setValue(propertie.getValue());\r\n\t\t\tgenText.setTheBackground(b);\r\n\t\t}\r\n\t}\r\n}\r\nreturn genText;'"
	 * @generated
	 */

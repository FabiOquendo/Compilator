...
public class StylesAdapterFactory extends AdapterFactoryImpl {
	...
	protected StylesSwitch<Adapter> modelSwitch =
		new StylesSwitch<Adapter>() {
			@Override
			public Adapter caseModelFactoryStyles(ModelFactoryStyles object) {
				return createModelFactoryStylesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link styles.ModelFactoryStyles <em>Model Factory Styles</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createModelFactoryStylesAdapter() {
		return null;
	}

...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>generator</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				ExpressionModelManager root = GeneratorFactory.eINSTANCE.createExpressionModelManager();

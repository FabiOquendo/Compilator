...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>individualcomponent</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class IndividualcomponentExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(IndividualcomponentPackage.eNS_URI, 
			 IndividualcomponentPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.individualcomponent"));
				Button root = IndividualcomponentFactory.eINSTANCE.createButton();

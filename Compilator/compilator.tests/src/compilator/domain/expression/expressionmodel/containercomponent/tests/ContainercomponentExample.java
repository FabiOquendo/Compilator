...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>containercomponent</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainercomponentExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ContainercomponentPackage.eNS_URI, 
			 ContainercomponentPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.containercomponent"));
				Container root = ContainercomponentFactory.eINSTANCE.createContainer();

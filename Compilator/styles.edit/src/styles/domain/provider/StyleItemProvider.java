...
/**
 * This is the item provider adapter for a {@link styles.domain.Style} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StyleItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTheCharacteristicPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.STYLE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the The Characteristic feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTheCharacteristicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Style_theCharacteristic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Style_theCharacteristic_feature", "_UI_Style_type"),
				 DomainPackage.Literals.STYLE__THE_CHARACTERISTIC,
				 true,
				 false,
				 true,
				 null,
